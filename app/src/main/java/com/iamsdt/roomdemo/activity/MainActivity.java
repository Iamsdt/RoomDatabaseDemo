package com.iamsdt.roomdemo.activity;
...
import com.iamsdt.roomdemo.adapter.NoteAdapter;
import com.iamsdt.roomdemo.database.AppDatabase;
...
public class MainActivity extends AppCompatActivity
        implements NoteAdapter.ActionCallback, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleCallback callback = new SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            @Override
